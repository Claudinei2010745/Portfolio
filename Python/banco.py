...
from MiniProjeto2.dsaentidades.cliente import Cliente

# Importa a classe base Conta e suas subclasses (Corrente e Poupança)
from MiniProjeto2.dsaentidades.conta import Conta, ContaCorrente, ContaPoupanca

# Importa exceção personalizada para conta inexistente
from MiniProjeto2.dsautilitarios.exceptions import ContaInexistenteError
